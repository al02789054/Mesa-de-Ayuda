...
/**
 * Establece el escaneo de componentes del paquete me.jmll.ti.web con filtro de
...
@ComponentScan(
		basePackageClasses = {
			   		me.jmll.ti.web.ComponentPackageMaker.class,
			   		me.jmll.ti.repository.ComponentPackageMaker.class,
			   		me.jmll.ti.service.ComponentPackageMaker.class,
			   		me.jmll.ti.component.ComponentPackageMaker.class}, 
...
public class RootContextConfig implements AsyncConfigurer, SchedulingConfigurer {
	...
	public Jaxb2Marshaller jaxb2Marshaller() {
		...
		marshaller.setPackagesToScan(new String[] { "me.jmll.ti.model" });
		return marshaller;
	}
	...
	public ThreadPoolTaskScheduler taskScheduler() {
		/**
		 * Configura ThreadPoolTaskScheduler con un tamaáo de pool
